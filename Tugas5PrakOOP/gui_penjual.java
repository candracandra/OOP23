 ...
 */
public class gui_penjual extends javax.swing.JFrame {

    /**
     * Creates new form gui_penjual
     */
    public gui_penjual() {
        initComponents();
    }
    ...
    private void btncetak1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncetak1ActionPerformed
        ...
        penjual nt = new penjual();
        nt.setNama(txtnama.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gui_penjual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gui_penjual().setVisible(true);
            }
        });
    }
