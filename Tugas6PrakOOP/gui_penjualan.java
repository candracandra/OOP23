...
public class gui_penjualan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblhasil.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama Pembeli", "Alamat", "No Telpon", "Seragam Yang Dibeli"
            }
        ));
    ...
    private void btncetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncetakActionPerformed
        ...
        p.setNotelpon(txtnotelpon.getText());
        p.setPilihSeragam(txtseragam.getText());
   

        
        list.add(p.getNama());
        list.add(p.getAlamat());
        list.add(p.getNoTelpon());
        list.add(p.getPilihSeragam());
